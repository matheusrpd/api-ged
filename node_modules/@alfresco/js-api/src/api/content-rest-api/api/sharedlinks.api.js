...
class SharedlinksApi extends base_api_1.BaseApi {
    createSharedLink(sharedLinkBodyCreate, opts) {
        assert_1.throwIfNotDefined(sharedLinkBodyCreate, 'sharedLinkBodyCreate');
        opts = opts || {};
    ...
    deleteSharedLink(sharedId) {
        assert_1.throwIfNotDefined(sharedId, 'sharedId');
        let postBody = null;
        let pathParams = {
            'sharedId': sharedId
        };
    ...
    emailSharedLink(sharedId, sharedLinkBodyEmail) {
        assert_1.throwIfNotDefined(sharedId, 'sharedId');
        assert_1.throwIfNotDefined(sharedLinkBodyEmail, 'sharedLinkBodyEmail');
