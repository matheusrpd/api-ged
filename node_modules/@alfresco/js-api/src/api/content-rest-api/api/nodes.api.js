...
class NodesApi extends base_api_1.BaseApi {
    copyNode(nodeId, nodeBodyCopy, opts) {
        ...
        assert_1.throwIfNotDefined(nodeBodyCopy, 'nodeBodyCopy');
        opts = opts || {};
    ...
    createAssociation(nodeId, associationBodyCreate, opts) {
        assert_1.throwIfNotDefined(nodeId, 'nodeId');
        assert_1.throwIfNotDefined(associationBodyCreate, 'associationBodyCreate');
        opts = opts || {};
    ...
    createNode(nodeId, nodeBodyCreate, opts, formParams) {
        assert_1.throwIfNotDefined(nodeId, 'nodeId');
        assert_1.throwIfNotDefined(nodeBodyCreate, 'nodeBodyCreate');
        opts = opts || {};
    ...
    createSecondaryChildAssociation(nodeId, secondaryChildAssociationBodyCreate, opts) {
        assert_1.throwIfNotDefined(nodeId, 'nodeId');
        assert_1.throwIfNotDefined(secondaryChildAssociationBodyCreate, 'secondaryChildAssociationBodyCreate');
        opts = opts || {};
    ...
    deleteAssociation(nodeId, targetId, opts) {
        assert_1.throwIfNotDefined(nodeId, 'nodeId');
        assert_1.throwIfNotDefined(targetId, 'targetId');
        opts = opts || {};
        let postBody = null;
        let pathParams = {
    ...
    deleteSecondaryChildAssociation(nodeId, childId, opts) {
        assert_1.throwIfNotDefined(nodeId, 'nodeId');
        assert_1.throwIfNotDefined(childId, 'childId');
        opts = opts || {};
        let postBody = null;
        let pathParams = {
    ...
    lockNode(nodeId, nodeBodyLock, opts) {
        assert_1.throwIfNotDefined(nodeId, 'nodeId');
        assert_1.throwIfNotDefined(nodeBodyLock, 'nodeBodyLock');
        opts = opts || {};
    ...
    moveNode(nodeId, nodeBodyMove, opts) {
        assert_1.throwIfNotDefined(nodeId, 'nodeId');
        assert_1.throwIfNotDefined(nodeBodyMove, 'nodeBodyMove');
        opts = opts || {};
    ...
    updateNode(nodeId, nodeBodyUpdate, opts) {
        assert_1.throwIfNotDefined(nodeId, 'nodeId');
        assert_1.throwIfNotDefined(nodeBodyUpdate, 'nodeBodyUpdate');
        opts = opts || {};
    ...
    updateNodeContent(nodeId, contentBodyUpdate, opts) {
        assert_1.throwIfNotDefined(nodeId, 'nodeId');
        assert_1.throwIfNotDefined(contentBodyUpdate, 'contentBodyUpdate');
        opts = opts || {};
