...
class CommentsApi extends base_api_1.BaseApi {
    createComment(nodeId, commentBodyCreate, opts) {
        ...
        assert_1.throwIfNotDefined(commentBodyCreate, 'commentBodyCreate');
        opts = opts || {};
    ...
    deleteComment(nodeId, commentId) {
        assert_1.throwIfNotDefined(nodeId, 'nodeId');
        assert_1.throwIfNotDefined(commentId, 'commentId');
        let postBody = null;
        let pathParams = {
    ...
    updateComment(nodeId, commentId, commentBodyUpdate, opts) {
        assert_1.throwIfNotDefined(nodeId, 'nodeId');
        assert_1.throwIfNotDefined(commentId, 'commentId');
        assert_1.throwIfNotDefined(commentBodyUpdate, 'commentBodyUpdate');
        opts = opts || {};
