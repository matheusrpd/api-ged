...
class ClassificationGuidesApi extends base_api_1.BaseApi {
    ...
    createClassificationGuide(classificationGuide) {
        assert_1.throwIfNotDefined(classificationGuide, 'classificationGuide');
    ...
    createSubtopic(topicId, topic, opts) {
        assert_1.throwIfNotDefined(topicId, 'topicId');
        assert_1.throwIfNotDefined(topic, 'topic');
        opts = opts || {};
        let postBody = topic;
        let pathParams = {
            'topicId': topicId
    ...
    createTopic(classificationGuideId, topic, opts) {
        assert_1.throwIfNotDefined(classificationGuideId, 'classificationGuideId');
        assert_1.throwIfNotDefined(topic, 'topic');
        opts = opts || {};
        let postBody = topic;
        let pathParams = {
