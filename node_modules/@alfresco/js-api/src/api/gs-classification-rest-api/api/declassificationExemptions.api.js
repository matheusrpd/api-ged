...
class DeclassificationExemptionsApi extends base_api_1.BaseApi {
    createDeclassificationExemption(declassificationExemption) {
        assert_1.throwIfNotDefined(declassificationExemption, 'declassificationExemption');
    ...
    deleteDeclassificationExemption(declassificationExemptionId) {
        assert_1.throwIfNotDefined(declassificationExemptionId, 'declassificationExemptionId');
        let postBody = null;
        let pathParams = {
