...
class AdminGroupsApi extends base_api_1.BaseApi {
    activate(groupId) {
        assert_1.throwIfNotDefined(groupId, 'groupId');
        let postBody = null;
        let pathParams = {
            'groupId': groupId
        };
    ...
    addGroupCapabilities(groupId, addGroupCapabilitiesRepresentation) {
        assert_1.throwIfNotDefined(groupId, 'groupId');
        assert_1.throwIfNotDefined(addGroupCapabilitiesRepresentation, 'addGroupCapabilitiesRepresentation');
    ...
    addGroupMember(groupId, userId) {
        assert_1.throwIfNotDefined(groupId, 'groupId');
        assert_1.throwIfNotDefined(userId, 'userId');
        let postBody = null;
        let pathParams = {
    ...
    addRelatedGroup(groupId, relatedGroupId, type) {
        assert_1.throwIfNotDefined(groupId, 'groupId');
        assert_1.throwIfNotDefined(relatedGroupId, 'relatedGroupId');
        assert_1.throwIfNotDefined(type, 'type');
        let postBody = null;
        let pathParams = {
    ...
    createNewGroup(groupRepresentation) {
        assert_1.throwIfNotDefined(groupRepresentation, 'groupRepresentation');
    ...
    deleteGroupCapability(groupId, groupCapabilityId) {
        assert_1.throwIfNotDefined(groupId, 'groupId');
        assert_1.throwIfNotDefined(groupCapabilityId, 'groupCapabilityId');
        let postBody = null;
        let pathParams = {
