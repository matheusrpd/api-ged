...
class FormModelsApi extends base_api_1.BaseApi {
    getFormEditorJson(formId) {
        assert_1.throwIfNotDefined(formId, 'formId');
        let postBody = null;
        let pathParams = {
            'formId': formId
        };
    ...
    getFormHistory(formId, formHistoryId) {
        assert_1.throwIfNotDefined(formId, 'formId');
        assert_1.throwIfNotDefined(formHistoryId, 'formHistoryId');
        let postBody = null;
        let pathParams = {
    ...
    getForms(input) {
        ...
        if (typeof input === 'string') {
            let queryParams = {
                'formId': alfrescoApiClient_1.buildCollectionParam(input, 'multi')
            };
    ...
    saveForm(formId, saveRepresentation) {
        assert_1.throwIfNotDefined(formId, 'formId');
        assert_1.throwIfNotDefined(saveRepresentation, 'saveRepresentation');
