...
class UsersApi extends base_api_1.BaseApi {
    executeAction(userId, actionRequest) {
        ...
        assert_1.throwIfNotDefined(actionRequest, 'actionRequest');
    ...
    requestPasswordReset(resetPassword) {
        assert_1.throwIfNotDefined(resetPassword, 'resetPassword');
    ...
    updateUser(userId, userRequest) {
        assert_1.throwIfNotDefined(userId, 'userId');
        assert_1.throwIfNotDefined(userRequest, 'userRequest');
