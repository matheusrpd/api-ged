...
class ProcessDefinitionsApi extends base_api_1.BaseApi {
    createIdentityLink(processDefinitionId, identityLinkRepresentation) {
        assert_1.throwIfNotDefined(processDefinitionId, 'processDefinitionId');
        assert_1.throwIfNotDefined(identityLinkRepresentation, 'identityLinkRepresentation');
    ...
    deleteIdentityLink(processDefinitionId, family, identityId) {
        assert_1.throwIfNotDefined(processDefinitionId, 'processDefinitionId');
        assert_1.throwIfNotDefined(family, 'family');
        assert_1.throwIfNotDefined(identityId, 'identityId');
        let postBody = null;
        let pathParams = {
