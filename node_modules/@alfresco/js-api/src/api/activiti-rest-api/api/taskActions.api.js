...
class TaskActionsApi extends base_api_1.BaseApi {
    assignTask(taskId, userIdentifier) {
        ...
        assert_1.throwIfNotDefined(userIdentifier, 'userIdentifier');
    ...
    attachForm(taskId, formIdentifier) {
        assert_1.throwIfNotDefined(taskId, 'taskId');
        assert_1.throwIfNotDefined(formIdentifier, 'formIdentifier');
    ...
    removeInvolvedUser(taskId, identifier) {
        assert_1.throwIfNotDefined(taskId, 'taskId');
        assert_1.throwIfNotDefined(identifier, 'identifier');
        let pathParams = {
