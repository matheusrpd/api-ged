...
class TaskFormsApi extends base_api_1.BaseApi {
    completeTaskForm(taskId, completeTaskFormRepresentation) {
        assert_1.throwIfNotDefined(taskId, 'taskId');
        assert_1.throwIfNotDefined(completeTaskFormRepresentation, 'completeTaskFormRepresentation');
    ...
    getRestFieldValues(taskId, field) {
        assert_1.throwIfNotDefined(taskId, 'taskId');
        assert_1.throwIfNotDefined(field, 'field');
        let postBody = null;
        let pathParams = {
    ...
    saveTaskForm(taskId, saveTaskFormRepresentation) {
        assert_1.throwIfNotDefined(taskId, 'taskId');
        assert_1.throwIfNotDefined(saveTaskFormRepresentation, 'saveTaskFormRepresentation');
