...
class AppDefinitionsApi extends base_api_1.BaseApi {
    deleteAppDefinition(appDefinitionId) {
        assert_1.throwIfNotDefined(appDefinitionId, 'appDefinitionId');
        let postBody = null;
        let pathParams = {
    ...
    exportAppDefinition(modelId) {
        assert_1.throwIfNotDefined(modelId, 'modelId');
        let postBody = null;
        let pathParams = {
            'modelId': modelId
        };
    ...
    importAndPublishApp(file) {
        assert_1.throwIfNotDefined(file, 'file');
        let postBody = null;
        let pathParams = {};
        let queryParams = {};
        let headerParams = {};
    ...
    publishAppDefinition(modelId, publishModel) {
        assert_1.throwIfNotDefined(modelId, 'modelId');
        assert_1.throwIfNotDefined(publishModel, 'publishModel');
    ...
    updateAppDefinition(modelId, updatedModel) {
        assert_1.throwIfNotDefined(modelId, 'modelId');
        assert_1.throwIfNotDefined(updatedModel, 'updatedModel');
