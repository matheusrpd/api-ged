...
class UserFiltersApi extends base_api_1.BaseApi {
    createUserProcessInstanceFilter(userProcessInstanceFilterRepresentation) {
        assert_1.throwIfNotDefined(userProcessInstanceFilterRepresentation, 'userProcessInstanceFilterRepresentation');
    ...
    createUserTaskFilter(userTaskFilterRepresentation) {
        assert_1.throwIfNotDefined(userTaskFilterRepresentation, 'userTaskFilterRepresentation');
    ...
    deleteUserProcessInstanceFilter(userFilterId) {
        assert_1.throwIfNotDefined(userFilterId, 'userFilterId');
        let postBody = null;
        let pathParams = {
    ...
    orderUserProcessInstanceFilters(filterOrderRepresentation) {
        assert_1.throwIfNotDefined(filterOrderRepresentation, 'filterOrderRepresentation');
